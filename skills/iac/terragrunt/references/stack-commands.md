...
terragrunt stack run apply --filter '.terragrunt-stack/workload-policies'

# Target a specific unit (legacy syntax)
terragrunt stack run apply --queue-include-dir ".terragrunt-stack/workload-policies"

# Target multiple specific units
terragrunt stack run plan --filter '.terragrunt-stack/database' --filter '.terragrunt-stack/vault-secrets'
